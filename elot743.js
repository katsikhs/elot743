...
window.onload = function() {
        ...
        inputElement.focus()
        inputElement.onkeyup = transform
        inputElement.onmouseup = transform
        inputElement = null
        var prevText = null
        transform()
        function transform() {
          ...
          if (prevText != text) {
            prevText = text
            document.getElementById('output').value = toGreeklish(text)
          }
        }
      }
      ...
      function toGreeklish(text) {
        ...
        text = text.replace(expression, function($0, index) {
          ...
          if (replacement.bi) {
            ...
            var c2 = replacements[$0.charAt(1).toLowerCase()].greeklish ? 'f' : 'v'
